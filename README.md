...
# 基本概念
- 法术分为前端和后端
- **前端**：使用Reactflow实现的web工作流编辑器，输出json格式的法术程序给后端执行
...
**设计特点**：
- 没有传统的运算符（operator），加减乘除都是库函数调用
- 没有循环语句，通过递归实现
- 列表通过函数式方式实现（cons、head、tail等）
