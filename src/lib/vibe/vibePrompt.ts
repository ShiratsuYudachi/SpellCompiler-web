...
- if: data = {} (has targetHandles: condition, then, else; sourceHandle: result) — NOT a lambda. Never pair an if node with lambdaDef/functionOut. The then/else handles accept any value expression (e.g. a dynamicFunction result or a literal), NOT a function reference.
